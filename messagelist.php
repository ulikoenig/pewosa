...
<?
	...
	For ($i=1;$i<=$counter;$i++)
		...
		echo "<div class='panel-heading'><a href='$send_id'><Font size='4'><span class='badge' title='PM-Nummer $take'>PM $take</span> $showsubject </font></a>";
...
If ($sendstate[$take]!=0)
		...
		If ($senddate[$take]!='')
			...
			If ($sendstate[$take]!='-1' AND $sendstate[$take]!='-2' AND $sendstate[$take]<=0){echo "<button type='button' class='btn btn-info' title='Warten auf Versand' disabled></span></button>";}
